...
public class HW04_PasswordKosullarý {
   ...
   */
   ...
   if(pasword.length()>=10) {
       ...
       if(numOfSembol>0 && numOfRakam>0 && numOfBuyukHarf>0 && numOfKucukHarf>0 ) {
           ...
           System.out.println("Password unun basarýlý bir sekilde olusturulmustur");
       }else {
           System.out.println("Sartlarýnýz malesef password olusturmaya yetmiyor");
       }
   }
